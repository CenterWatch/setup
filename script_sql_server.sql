...
CREATE TABLE questionario (
    id_apontamento INT PRIMARY KEY IDENTITY,
    nota INT,
...
CREATE TABLE tarefa (
    ...
    dt_hora_concluida DATETIME DEFAULT GETDATE(),
    fk_funcionario INT NOT NULL,
...
CREATE TABLE usuario (
    ...
    username VARCHAR(80),
    senha VARCHAR(80) CHECK (LEN(senha) >= 8),
...
CREATE TABLE tempo_ociosidade (
    id_tempo_ociosidade INT PRIMARY KEY IDENTITY,
...
CREATE TABLE artigo (
    id_artigo INT PRIMARY KEY IDENTITY,
    titulo VARCHAR(25),
    descricao VARCHAR(2000),
    categoria VARCHAR(45),
    palavra_chave VARCHAR(45),
    dt_hora_criacao DATETIME DEFAULT GETDATE(),
    fk_funcionario INT,
...
CREATE TABLE maquina (
    ...
    ram_total BIGINT,
    ultima_mod DATETIME DEFAULT GETDATE(),  
    fk_empresa INT,
...
CREATE TABLE registro_volume (
    id_registro_volume INT PRIMARY KEY IDENTITY,
